...
class PaymentViewerPage(BasePage):
    def __init__(self,driver):
        ...
        self.locators = {
            ...
            "payment_out_ref":(By.XPATH,"//tr[@class='MuiTableRow-root css-1gqug66'][1]/td[@class='MuiTableCell-root MuiTableCell-body MuiTableCell-alignRight MuiTableCell-sizeSmall css-507wcy'][7]"),
            }
