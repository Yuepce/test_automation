...
class HomePage(BasePage):
    def __init__(self,driver):
        ...
        self.locators = {
            ...
            "impf_home_page_title":(By.XPATH,"//div[@class='text1']"),
...
#            "ealert_sunsurf_tab":(By.XPATH,"//a[text()='E-alert and SunSurf Consent Flag']"),
    ...
    def verify_finances_tab(self):
        finance_tab = self.find_element(*self.locators["finance_tab"])
        return finance_tab.text
